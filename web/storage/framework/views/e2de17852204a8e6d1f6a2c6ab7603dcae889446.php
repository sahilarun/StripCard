        ...
        <div class="card-body">
            <form class="card-form" action="<?php echo e(setRoute('admin.virtual.card.api.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-10-none">
                    ...
                    <div class="col-xl-12 col-lg-12 form-group">
                        <label for="card-image"><?php echo e(__("Background Image")); ?></label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-8.0.2\htdocs\strip_card_final\full_project\resources\views/admin/sections/virtual-card/api.blade.php ENDPATH**/ ?>