<div id="about-add" class="mfp-hide large">
    <div class="modal-data">
        <div class="modal-header px-0">
            <h5 class="modal-title"><?php echo e(__("Add Activity")); ?></h5>
        </div>
...
<?php /**PATH E:\xampp-8.0.2\htdocs\stripe_card\resources\views/admin/components/modals/site-section/add-about-item.blade.php ENDPATH**/ ?>