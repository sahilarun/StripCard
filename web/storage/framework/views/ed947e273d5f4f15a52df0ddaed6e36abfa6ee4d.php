            ...
            <div class="dashboard-list-item sent">
                <div class="dashboard-list-left">
                    <div class="dashboard-list-user-wrapper">
                        ...
                        <div class="dashboard-list-user-content">
                            ...
                            <?php elseif(@$item->type == payment_gateway_const()::WITHDRAWMONEY): ?>
                                <h4 class="title"><?php echo e(__("Withdrawe Money")); ?> <span class="text--warning"><?php echo e(@$item->currency->gateway->name); ?></span></h4>
                ...
                <div class="dashboard-list-right">
                    <?php if(@$item->type == payment_gateway_const()::TYPEADDMONEY): ?>
                        ...
                        <h6 class="exchange-money fw-bold"><?php echo e(get_amount(@$item->payable,@$item->currency->currency_code)); ?></h6>
                    <?php elseif(@$item->type == payment_gateway_const()::WITHDRAWMONEY): ?>
                        <h6 class="exchange-money text--warning fw-bold"><?php echo e(get_amount(@$item->request_amount,get_default_currency_code())); ?></h6>
                        <h4 class="main-money "><?php echo e(get_amount(@$item->payable,get_default_currency_code())); ?></h4>
                    <?php elseif(@$item->type == payment_gateway_const()::BILLPAY): ?>
                        <h4 class="main-money text--warning"><?php echo e(get_amount(@$item->request_amount,get_default_currency_code())); ?></h4>
            ...
            <div class="preview-list-wrapper">
                ...
                <div class="preview-list-item">
                    ...
                    <div class="preview-list-right">
                        ...
                        <?php elseif(@$item->type == payment_gateway_const()::WITHDRAWMONEY): ?>
                            <span>1 <?php echo e(get_default_currency_code()); ?> = <?php echo e(get_amount(@$item->details->withdraw_data->gateway_rate,@$item->currency->currency_code)); ?></span>
                        <?php elseif(@$item->type == payment_gateway_const()::TYPEMONEYEXCHANGE): ?>
                ...
                <?php else: ?>
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            ...
                            <?php elseif(@$item->type == payment_gateway_const()::WITHDRAWMONEY): ?>
                                <span><?php echo e(getAmount(@$item->charge->total_charge,4)); ?> <?php echo e(get_default_currency_code()); ?></span>
                            <?php elseif(@$item->type == payment_gateway_const()::BILLPAY): ?>
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            ...
                            <?php elseif(@$item->type == payment_gateway_const()::WITHDRAWMONEY): ?>
                                ...
                                <span><?php echo e(get_amount(@$item->details->withdraw_data->conversion_amount,@$item->currency->currency_code)); ?></span>
                            <?php elseif(@$item->type == payment_gateway_const()::BILLPAY): ?>
...
<?php endif; ?>
<?php /**PATH E:\xampp-8.0.2\htdocs\strip_card\v-2.0.0\full_project\resources\views/user/components/transaction-log.blade.php ENDPATH**/ ?>