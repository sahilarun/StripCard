...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function getPreview() {
                ...
                var willGet = parseFloat(willGetAmount).toFixed(4);
                ...
                $('.pay-in-total').text(parseFloat(pay_in_total).toFixed(4) + " " + defualCurrency);
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-8.0.2\htdocs\strip_card\v-2.0.0\full_project\resources\views/user/sections/withdraw/index.blade.php ENDPATH**/ ?>