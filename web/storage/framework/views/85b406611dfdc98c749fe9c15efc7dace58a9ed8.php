...
<?php $__env->startSection('content'); ?>
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#service-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> <?php echo e(__("Add Item ")); ?></a>
                </div>
            </div>
    ...
    <?php echo $__env->make('admin.components.modals.site-section.add-service-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    
    <div id="service-edit" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title"><?php echo e(__("Edit Item")); ?></h5>
            </div>
 ...
 <script src="<?php echo e(asset('public/backend/js/fontawesome-iconpicker.js')); ?>"></script>
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            fileHolderPreviewReInit("#service-edit input[name=image]");
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-8.0.2\htdocs\stripe_card\resources\views/admin/sections/setup-sections/service-section.blade.php ENDPATH**/ ?>