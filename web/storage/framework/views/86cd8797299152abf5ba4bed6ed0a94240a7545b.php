...
<div class="body-wrapper">
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="deposit-form">
                        ...
                        <div class="row justify-content-center">
                            <form class="card-form" action="<?php echo e(setRoute("user.add.money.submit")); ?>" method="POST">
                             <?php echo csrf_field(); ?>
                            <div class="col-lg-12">
                                    ...
                                    <label><?php echo e(__("Payment Gateway")); ?><span>*</span></label>
                                     <div class="method ">
                                        <select class="form--control nice-select gateway-select" name="currency">
                                            <?php $__currentLoopData = $payment_gateways_currencies ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                ...
                                <div class="note-area d-flex justify-content-between">
                                  ...
                                  <div class="button pt-3">
                                    <button type="submit" class="btn--base w-100 btn-loading sendBtn"><?php echo e(__("Conform")); ?></i></button>
                                  </div>
                            </div>
                            </form>
                        </div>
    ...
    <div class="dashboard-list-area mt-20">
        <div class="dashboard-header-wrapper">
            <h4 class="title"><?php echo e(__("Add Money Log")); ?></h4>
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-8.0.2\htdocs\adcard-update\resources\views/user/sections/add-money/index.blade.php ENDPATH**/ ?>