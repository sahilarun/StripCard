...
<head>
    ...
    <!-- bootstrap css link -->
    <link rel="stylesheet" href="<?php echo e(asset('/resources/installer/src/assets/css/bootstrap.min.css')); ?>">
    <!-- favicon -->
...
<!-- jquery -->
<script src="<?php echo e(asset('../resources/installer/src/assets/js/jquery-3.6.0.min.js')); ?>"></script>
<!-- bootstrap js -->
<script src="<?php echo e(asset('../resources/installer/src/assets/js/bootstrap.bundle.min.js')); ?>"></script>
<!-- smooth scroll js -->
<script src="<?php echo e(asset('../resources/installer/src/assets/js/smoothscroll.min.js')); ?>"></script>
<!-- lightcase js-->
...
</html><?php /**PATH F:\xampp-8.0\htdocs\Project-Modify\stripe-card\resources\installer\src\views/installer/layouts/app.blade.php ENDPATH**/ ?>