    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form class="card-form row g-4" action="<?php echo e(route('user.sudo.virtual.card.create')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                    <div class="col-12">
                        <div class="row">
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\xampp-8.0.2\htdocs\adcard-update\resources\views/partials/sudo-card-modals.blade.php ENDPATH**/ ?>