...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/backend/css/fontawesome-all.min.css')); ?>">
    <!-- bootstrap css link -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/backend/css/line-awesome.min.css')); ?>">
    <!-- animate.css -->
...
<!-- bootstrap js -->
<script src="<?php echo e(asset('public/backend/js/bootstrap.bundle.min.js')); ?>"></script>
<!-- smooth scroll js -->
<script src="<?php echo e(asset('public/backend/js/smoothscroll.min.js')); ?>"></script>
<!-- nice select js -->
...
<?php /**PATH E:\xampp-8.0.2\htdocs\adcard-update\resources\views/admin/auth/layouts/auth-master.blade.php ENDPATH**/ ?>