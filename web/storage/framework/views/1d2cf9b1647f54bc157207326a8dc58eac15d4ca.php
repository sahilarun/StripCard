                ...
                <div class="col-xxxl-3 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="left">
                                <h6 class="title"><?php echo e(__("Stripe Available Balance")); ?></h6>
                                <div class="user-info">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-8.0.2\htdocs\strip_card\v-1.2.1\full_project\resources\views/admin/sections/dashboard/index.blade.php ENDPATH**/ ?>