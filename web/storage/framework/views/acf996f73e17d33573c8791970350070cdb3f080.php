<?php if(admin_permission_by_name("admin.support.ticket.messaage.reply")): ?>
        ...
        <?php if(isset($support_ticket) && isset($support_ticket->token)): ?>
            <?php if($basic_settings->broadcast_config != null && $basic_settings->broadcast_config->method == "pusher"): ?>
                ...
                <script>
                    ...
                    var adminProfile = "<?php echo e(get_image(auth()->user()->image,'admin-profile')); ?>";
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH E:\xampp-8.0.2\htdocs\stripe_card\resources\views/admin/components/support-ticket/conversation/connection-admin.blade.php ENDPATH**/ ?>