                            ...
                            <tr>
                                ...
                                <td>
                                    @include('admin.components.link.edit-default',[
                                        'href'          => setRoute('admin.payment.gateway.edit',['money-out','automatic',$item->alias]),
            ...
            <div id="p-gateway-automatic-add" class="mfp-hide large">
                <div class="modal-data">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __("Add Automatic Gateway (Money Out)") }}</h5>
                    </div>
                    <div class="modal-form-data">
                        <form class="modal-form" method="POST" action="{{ setRoute('admin.payment.gateway.store',['money-out','automatic']) }}" enctype="multipart/form-data">
                            @csrf
...
@push('script')
    <script>
        $(document).ready(function(){
            openModalWhenError("automatic-money-out","#p-gateway-automatic-add");
