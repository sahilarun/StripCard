...
class SendMoneyLogScreen extends StatelessWidget {
  const SendMoneyLogScreen({Key? key, required this.controller})
      : super(key: key);
  ...
  _mainListWidget(int index, List<SendMoney> data, BuildContext context) {
    return TransactionWidget(
      amount:data[index].requestAmount.toString(),
