...
class RazorPayWebPaymentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(
        text: Strings.razorpayPayment.tr,
        onTap: () {
  ...
  _bodyWidget(BuildContext context) {
    var paymentUrl = controller.automaticPaymentRazorpayModel.data.url;
    ...
    return InAppWebView(
      ...
      onLoadStop: (controller, url) {
        ...
        if (url.toString().contains('razorpay/payment/success/')) {
          StatusScreen.show(
              context: context,
